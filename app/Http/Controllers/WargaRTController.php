...
class WargaRTController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'nomor_telepon' => 'max:15|unique:warga,nomor_telepon',
            'agama' => 'required',
        ...
        return redirect('/RT/Warga')->with('success', 'Data berhasil ditambah');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('RT.Warga.show', $data = ['data' => $warga]);
    }
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            ...
            'tanggal_lahir' => 'required',
            'alamat' => 'required|max:100',
            'nomor_telepon' => 'max:15|unique:warga,nomor_telepon,'.$id.',id_warga',
            'agama' => 'required',
            'pekerjaan' => 'required|max:40',
            'penghasilan' => 'required|numeric|min:0',
            'status_hubungan' => 'required',
        ...
        return redirect('/RT/Warga')->with('success', 'Data berhasil diupdate');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$check) {
            return redirect('/RT/Warga')->with('error', 'Data tidak ditemukan');
        }

        try {
            WargaModel::destroy($id);

            return redirect('/RT/Warga')->with('success', 'Data berhasil dihapus');
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect('/RT/Warga')->with('error', 'Data gagal dihapus');
        }
    }
}
