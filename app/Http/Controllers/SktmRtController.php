...
class SktmRTController extends Controller
{
/**
    ...
    public function index(Request $request)
    {
        ...
        return view('RT.Sktm.index', ['sktm' => $sktm, 'startNumber' => $startNumber]);
    }
    ...
    public function create()
    {
        ...
        return view('RT.Sktm.create', compact('niks'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/RT/Sktm')->with('success', 'Data berhasil ditambah');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('RT.Sktm.show', $data = ['data' => $sktm]);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('RT.Sktm.edit', $data = ['data' => $sktm], compact('niks'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/RT/Sktm')->with('success', 'Data berhasil diupdate');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$check) {
            return redirect('/RT/Sktm')->with('error', 'Data tidak ditemukan');
        }
        ...
        try {
            ...
            return redirect('/RT/Sktm')->with('success', 'Data berhasil dihapus');
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect('/RT/Sktm')->with('error', 'Data gagal dihapus');
        }
    }
}
