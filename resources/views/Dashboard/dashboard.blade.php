...
@section('content')
    <div class="flex justify-center items-center">
        <div class=" container mx-auto px-40">
            <img src="{{ url('/assets/img/background_dashboard.png') }}" alt="Background Image"
            ...
            <main class="relative self-center mt-28 mb-20 w-full max-w-[1080px] max-md:my-10 max-md:max-w-full">
                <div class="flex gap-5 max-md:flex-col max-md:gap-0">
                    <figure class="flex flex-col w-[56%] max-md:ml-0 max-md:w-full">
                        <img src="{{ url('/assets/img/main.png') }}" alt="Main image"
                            class="w-full aspect-[1.79] max-md:mt-10 max-md:max-w-full" />
                    </figure>
                    <div class="flex flex-col ml-5 w-[44%] max-md:ml-0 max-md:w-full">
                        <div class="flex relative flex-col grow px-2  text-xl text-white max-md:mt-5 max-md:max-w-full">
                            <p class="max-md:max-w-full text-normal text-army-gelap ">
                                Selamat datang di portal <span class="font-bold">Sistem Informasi Rukun Warga 005 Tasikmadu,
                                    Kec. Lowokwaru, Kota Malang, Jawa Timur</span>. Tempat di mana informasi terkini dan
                                layanan tersedia untuk memenuhi kebutuhan Anda. Temukan berita terbaru, agenda kegiatan,
                                fasilitas umum, serta layanan penting lainnya untuk mendukung kenyamanan dan keamanan
                                lingkungan tempat tinggal Anda. Mari jelajahi dan manfaatkan layanan-layanan yang kami
        ...
        <div class="bg-login2 w-automx-4 shadow-xl md:mx-10 mr-3 md:mr-32 ml-4 md:ml-32 p-1 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-7 mx-auto md:px-20 content-center">
                @foreach ($berita as $data)
                    <div class="flex flex-col justify-center items-center">
                        <a href="berita/{{ $data->id_berita }}" class="mr-3 block cursor-pointer antialiased ">
                            <img src="{{ $data->gambar_berita }}" width="600" class="rounded-lg" style="margin:auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-7 px-4 md:px-20 item-center ">
                @foreach ($agenda as $data)
                    <div class="flex flex-col justify-center items-center">
                        <a href="agenda/{{ $data->id_agenda }}" class=" block cursor-pointer antialiased ">
                            <img src="{{ $data->gambar_agenda }}" width="600" class="rounded-lg" style="margin:auto">
                            <p class="text-normal text-army-gelap text-text font-bold">{{ $data->judul_agenda }} <br>
                                Tanggal dan Waktu : {{ \Carbon\Carbon::parse($data->tanggal_agenda)->format('d M Y H:i') }}
                                WIB</p>
                        </a>
                    </div>
                @endforeach
            ...
            <div class="h-140 grid grid-cols-1 md:grid-cols-3 gap-7 mx-auto md:px-40 content-center">
                @foreach ($fasilitas as $data)
                    <div class="flex flex-col justify-center items-center relative">
                        ...
                        <a href="fasilitasumum/{{ $data->id_fasilitas }}"
                            class="mr-4 block cursor-pointer antialiased relative">
                            <img src="{{ $data->gambar_fasilitas }}" width="400" class="rounded-lg" style="margin:auto">
                            <p
                                class="overlay-text text-abu-putih font-medium text-sub absolute bottom-0 left-0 right-0 bg-gray-900 bg-opacity-75 text-left p-4">
                                {{ $data->nama_fasilitas }}</p>
                        </a>
                    </div>
                @endforeach
            </div>
            ...
            <div class="h-140 grid grid-cols-1 md:grid-cols-4 gap-7 p-5 mx-auto md:px-80 content-center">
                <div class="items-center">
                    <a href="pengajuansurat" class="block cursor-pointer antialiased ">
                        <img src="{{ url('assets/img/pengajuansuratlogo.png') }}" width="150"style="margin:auto">
                        <p class="text-center font-bold text-army-gelap">PENGAJUAN SURAT</p>
                    </a>
                </div>
                <div class="flex flex-col justify-center items-center">
                    <a href="statusiuran" class="block cursor-pointer antialiased ">
                        <img src="{{ url('assets/img/catataniuranlogo.png') }}" width="150"style="margin:auto">
                ...
                <div class="flex flex-col justify-center items-center">
                    <a href="pengaduan" class="block cursor-pointer antialiased item-center">
                        <img src="{{ url('assets/img/pengaduanlogo.png') }}" width="150"style="margin:auto">
                        <p class="text-center font-bold text-army-gelap">PENGADUAN</p>
                    </a>
                </div>
                <div class="flex flex-col justify-center items-center">
                    <a href="layanandarurat" class="block cursor-pointer antialiased ">
                        <img src="{{ url('assets/img/layanandaruratlogo.png') }}" width="150" style="margin:auto">
