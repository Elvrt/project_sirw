...
@section('content')
    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-2 gap-4 item-center text-text text-center rounded-lg mx-56 bg-login2 px-20 py-20 ">
            <div class="">
                <a href="pilihrequestsurat" class="mr-4 block cursor-pointer antialiased rounded-lg">
                    <img src="{{url('assets/img/ajukansurat.png')}}"width="500" class="rounded-lg" style="margin:auto">
                    <p class="font-bold text-army-gelap ">Request Surat</p>
                </a>
            </div>
            <div class="">
                <a href="pilihstatussurat" class="mr-4 block cursor-pointer antialiased rounded-lg ">
