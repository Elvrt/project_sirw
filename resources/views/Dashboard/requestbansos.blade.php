...
@section('content')
    ...
    <div class="bg-putih shadow-md mx-5 py-10 px-8 relative">
        <form action="{{ route('bansos.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-10">
                <label for="nomorkk" class="block text-sm font-bold mb-2">Nomor KK</label>
            ...
            <button type="submit" class="w-max px-10 bg-coklat-muda text-putih font-semibold py-2 rounded-xl mx-auto block hover:bg-coklat mt-10 mb-6">Kirim</button>
        </form>
    </div>
@endsection
