...
@section('content')
    <!-- CONTENT -->
    <p class="text-center text-army-gelap font-bold text-header drop-shadow-md mt-10 mb-10">FORM REQUEST SURAT KETERANGAN TIDAK MAMPU</p>
    <div class="bg-putih shadow-md mx-5 mb-2 px-3">
        <p class="text-sub">FORM REQUEST SKTM</p>
        <a href="/pilihrequestsurat" class="bg-army-muda text-putih py-2 px-4 ml-20 mt-44 rounded-lg absolute top-0 left-0  flex items-center hover:bg-army-kuning">
    ...
    <div class="bg-putih shadow-md mx-5 py-10 px-8 relative">
        <form action="/requestsktm" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="mb-10">
