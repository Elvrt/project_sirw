...
@section('content')
    ...
    <div class="container mx-auto">
        ...
        <p class="text-center text-army-gelap font-bold text-header drop-shadow-md mt-10 mb-10">LAPORAN PENGADUAN</p>
        <div class="grid grid-cols-2 gap-4 item-center text-text text-center rounded-lg mx-56 bg-login2 px-20 py-20 ">
            <div class="">
                <a href="laporpengaduan" class="mr-4 block cursor-pointer antialiased rounded-lg">
                    <img src="{{url('assets/img/laporpengaduan.jpg')}}"width="500" class="rounded-lg" style="margin:auto">
                    <p class="font-bold text-army-gelap ">Lapor Pengaduhan</p>
                </a>
            </div>
            <div class="">
                <a href="statuspengaduan" class="mr-4 block cursor-pointer antialiased rounded-lg ">
                    <img src="{{url('assets/img/statussurat.png')}}" width="500" class="rounded-lg" style="margin:auto" >
                    <p class="font-bold text-army-gelap ">Status Pengaduhan</p>
                </a>
            </div>
        </div>
    </div>
