...
<body bgcolor="#FCFBF9">
    <!-- NAVBAR -->
    <nav
        class="block bg-abu-putih bg-opacity-80 shadow-md backdrop-blur-2xl backdrop-saturate-200 mx-auto px-4 lg:px-8 py-2 lg:py-4 w-full max-w-screen text-white">
        <div class="flex flex-wrap justify-between items-center mx-auto text-blue-gray-900 container">
            <div>
                <a href="#" class="block mr-4 antialiased cursor-pointer">
                    <img src="https://media.discordapp.net/attachments/1222905897848934450/1223143600188293180/image.png?ex=6618c83f&is=6606533f&hm=cab0f89b323bb3787adb4d760c00cc6813d8177267af06ac34416b8a20f35241&=&format=webp&quality=lossless"
                        width="200" />
                </a>
            </div>
            <div class="lg:block hidden">
                <ul class="flex lg:flex-row flex-col lg:items-center gap-2 lg:gap-6 mt-2 lg:mt-0 mb-4 lg:mb-0">
                    <li
                        class="flex items-center gap-x-2 p-1 font-sans font-semibold text-army-gelap text-blue-gray-90 text-lg antialiased leading-normal">
                        <a href="dashboard" class="flex items-center">
                            Beranda
                        </a>
                    </li>
                    <li
                        class="flex items-center gap-x-2 p-1 font-sans font-semibold text-army-gelap text-lg antialiased leading-normal">
            ...
            <button
                class="relative lg:hidden hover:bg-transparent focus:bg-transparent active:bg-transparent disabled:opacity-50 disabled:shadow-none ml-auto rounded-lg w-6 max-w-[40px] h-6 max-h-[40px] font-medium font-sans text-center text-inherit text-xs uppercase transition-all disabled:pointer-events-none select-none align-middle"
                type="button">
