...
<div class="bg-putih shadow-md mx-5 py-10 px-8">
    ...
    <div class="mb-10">
        <p>RT</p>
        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
            <input type="number" name="NoTelpon" id="NoTelpon" autocomplete="NoTelpon" min="1" max="8" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="RT" required>
        </div>
    </div>
    <div class="mb-10">
        <p>Judul Pengaduan</p>
        <textarea id="message" rows="1" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg  border border-army-gelap focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Judul Pengaduan"></textarea>
    </div>
    <div class="mb-10">
        <p>Keterangan</p>
    ...
    <div>
        <button class=" w-max px-10 bg-coklat-muda text-abu-putih font-semibold py-2 rounded-xl mx-auto block hover:bg-coklat focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 mt-10 mb-6">Kirim</button>
    </div>
    @endsection