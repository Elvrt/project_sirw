    ...
    <div class="bg-backgroundform md:mx-10 mr-3 md:mr-32 ml-4 md:ml-32 p-5 rounded-lg">
        ...
        <form action="/RW/Agenda/" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" name="gambar_agenda" id="gambar_agenda" value="{{old('gambar_agenda')}}" accept="image/*" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('gambar_agenda')
