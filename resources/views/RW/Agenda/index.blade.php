                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex gap-3">
                                            <a href="/RW/Agenda/{{ $data->id_agenda }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">Edit</a>
                                            <a href="#" data-toggle="modal" data-target="#ModalShow{{ $data->id_agenda }}" class="detail bg-abu-tua hover:bg-merah-gelap text-putih font-medium py-2 px-4 rounded-lg">Detail</a>
