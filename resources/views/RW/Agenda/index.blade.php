                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <form id="filter-form" method="GET" action="{{ url('/RW/Agenda') }}">
                                        <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">
                                            <div class="flex gap-3">
                                                <a href="/RW/Agenda/{{ $data->id_agenda }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">
...
@if(isset($data))
    @include('RW.Agenda.show', ['data' => $data])
@endif
