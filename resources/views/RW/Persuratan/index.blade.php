                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">
                                            <div class="flex gap-3">
                                                <a href="/RW/Persuratan/{{ $data->id_persuratan }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">
...
@if(isset($data))
    @include('RW.Persuratan.show', ['data' => $data])
@endif
