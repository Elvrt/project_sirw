...
<head>
    @extends('./layout/rw')
    <meta charset="UTF-8">
    <meta name="viewpofasilitas-umum" content="width=device-width, initial-scale=1.0">
            ...
            <div class="bg-putih drop-shadow-md mx-2 mt-5">
                ...
                <div class="col-span-7 mt-4 p-10 sm:ml-68 drop-shadow-md text-left mr-9"> 
                    ...
                    <div class="table-responsive">
                        <table id="table_fasilitas-umum" class="table-auto">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2">{{$data->alamat_fasilitas}}</td>
                                    <td class="px-4 py-2">
                                        <div class="flex gap-3">
                                            <a href="/RW/fasilitas-umum/{{ $data->id_fasilitas }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">Edit</a>
                                            <a href="#" data-toggle="modal" data-target="#ModalShow{{ $data->id_fasilitas }}" class="detail bg-abu-tua hover:bg-merah-gelap text-putih font-medium py-2 px-4 rounded-lg">Detail</a>
