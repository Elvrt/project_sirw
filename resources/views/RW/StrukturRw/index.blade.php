...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <p class="text-army-gelap font-bold text-header drop-shadow-md container mb-10 mt-10 ml-4">Data Struktur RW</p>
        <div class="bg-putih drop-shadow-md mx-2 px-10 p-4">
            {{-- <a href="StrukturRw/create">
                <button class="bg-hijau hover:bg-hijau-gelap text-putih font-bold py-2 px-4 rounded-lg float-right">
                    + Tambah Data Struktur RW
                </button>
            </a> --}}
            ...
            <div class="bg-putih drop-shadow-md mx-2 mt-5">
                ...
                <div class="col-span-6 mt-4 p-10 sm:ml-68 text-left ml-10 pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table_strukturRw" class="table-auto">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @forelse ($struktur as $data)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">{{$data->warga->nomor_telepon}}</td>
                                        <td class="px-4 py-2">
                                            <div class="flex gap-3">
                                                <a href="/RW/StrukturRw/{{ $data->id_struktur }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                                        <path d="M21.731 2.269a2.625 2.625 0 0 0-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 0 0 0-3.712ZM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 0 0-1.32 2.214l-.8 2.685a.75.75 0 0 0 .933.933l2.685-.8a5.25 5.25 0 0 0 2.214-1.32l8.4-8.4Z" />
                                                        <path d="M5.25 5.25a3 3 0 0 0-3 3v10.5a3 3 0 0 0 3 3h10.5a3 3 0 0 0 3-3V13.5a.75.75 0 0 0-1.5 0v5.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V8.25a1.5 1.5 0 0 1 1.5-1.5h5.25a.75.75 0 0 0 0-1.5H5.25Z" />
                                                    </svg>
                                                </a>
                                                <a href="#" data-toggle="modal" data-target="#ModalShow{{ $data->id_struktur }}" class="detail bg-abu-tua hover:bg-merah-gelap text-putih font-medium py-2 px-4 rounded-lg">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
...
@if(isset($data))
    @include('RW.StrukturRw.show', ['data' => $data])
@endif
