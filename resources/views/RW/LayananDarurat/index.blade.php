...
<body>
            ...
            <div class="bg-putih drop-shadow-md mx-2 mt-5">
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <form id="filter-form" method="GET" action="{{ url('/RW/LayananDarurat') }}">
                                        <div class="row">
                ...
                <div class="col-span-6 mt-4 p-10 sm:ml-68  text-left ml-10 pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table_layananDarurat" class="table-auto">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @forelse ($layanan as $data)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">{{$data->nama_layanan}}</td>
                                        <td class="px-4 py-2">{{$data->nomor_layanan}}</td>
                                        <td class="px-4 py-2">
                                            <div class="flex gap-3">
                                                <div class="flex gap-3">
                                                    <a href="/RW/LayananDarurat/{{ $data->id_layanan }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                                            <path d="M21.731 2.269a2.625 2.625 0 0 0-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 0 0 0-3.712ZM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 0 0-1.32 2.214l-.8 2.685a.75.75 0 0 0 .933.933l2.685-.8a5.25 5.25 0 0 0 2.214-1.32l8.4-8.4Z" />
                                                            <path d="M5.25 5.25a3 3 0 0 0-3 3v10.5a3 3 0 0 0 3 3h10.5a3 3 0 0 0 3-3V13.5a.75.75 0 0 0-1.5 0v5.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V8.25a1.5 1.5 0 0 1 1.5-1.5h5.25a.75.75 0 0 0 0-1.5H5.25Z" />
                                                        </svg>
                                                    </a>
                                                    <a href="#" data-toggle="modal" data-target="#ModalShow{{ $data->id_layanan }}" class="detail bg-abu-tua hover:bg-merah-gelap text-putih font-medium py-2 px-4 rounded-lg">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                                            <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                                            <path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 0 1 0-1.113ZM17.25 12a5.25 5.25 0 1 1-10.5 0 5.25 5.25 0 0 1 10.5 0Z" clip-rule="evenodd" />
                                                        </svg>
                                                    </a>
                                                    <form action="{{ url('/RW/LayananDarurat/' . $data->id_layanan) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="4" class="text-center px-4 py-2">No data found</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
    ...
    @if(isset($data))
        @include('RW.LayananDarurat.show', ['data' => $data])
    @endif
