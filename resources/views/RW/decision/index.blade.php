...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <p class="text-army-gelap font-bold text-header drop-shadow-md container mb-10 mt-10 ml-4">Matriks Keputusan</p>
            ...
            <div class="bg-putih drop-shadow-md mx-2 mt-5">
                ...
                <div class="col-span-6 mt-4 p-10 sm:ml-68  text-left ml-5 pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table_decision" class="table-auto w-full">
                            <thead>
                                <tr>
