...
<body bgcolor="#FCFBF9">
    <p class="text-center text-army-gelap font-bold text-header drop-shadow-md mt-5 mb-5">Form Edit Data Warga</p>
        ...
        <form action="{{url('/RW/Warga/'.$data->id_warga)}}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="id_rt" id="id_rt" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    @foreach($rts as $rt)
                        <option value="{{$rt->id_rt}}" {{old('id_rt', $data->kartuKeluarga->rt->id_rt) == $rt->id_rt ? "selected" : ""}}>{{$rt->nomor_rt}}</option>
                    @endforeach
                </select>
                @error('id_rt')
            ...
            <div class="mb-4">
                ...
                <select name="id_kk" id="id_kk" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    <option value="" disabled class="text-gray-400">Pilih No. KK</option>
                    @foreach($kks as $kk)
                        <option value="{{$kk->id_kk}}" {{old('id_kk', $data->kartuKeluarga->id_kk) == $kk->id_kk ? "selected" : ""}}>{{$kk->no_kk}}</option>
                    @endforeach
                </select>
                @error('id_kk')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="nik" value="{{old('nik', $data->nik)}}" id="nik" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('nik')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="text" name="nama_warga" value="{{old('nama_warga', $data->nama_warga)}}" id="nama_warga" value="{{old('nama_warga')}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('nama_warga')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <select name="jenis_kelamin" id="jenis_kelamin" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    <option value="" disabled class="text-gray-400">Pilih JK</option>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="tempat_lahir" value="{{old('tempat_lahir', $data->tempat_lahir)}}" id="tempat_lahir" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('tempat_lahir')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_lahir" value="{{old('tanggal_lahir', $data->tanggal_lahir)}}" id="tanggal_lahir" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('tanggal_lahir')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="text" name="alamat" value="{{old('alamat', $data->alamat)}}" id="alamat" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('alamat')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="text" name="nomor_telepon" value="{{old('nomor_telepon', $data->nomor_telepon)}}" id="nomor_telepon" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('nomor_telepon')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <select name="agama" id="agama" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    <option value="" disabled class="text-gray-400">Pilih Agama</option>
                    <option value="Islam" {{old('agama', $data->agama) == "Islam" ? "selected" : ""}}>Islam</option>
                    <option value="Kristen Katolik" {{old('agama', $data->agama) == "Kristen Katolik" ? "selected" : ""}}>Kristen Katolik</option>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="pekerjaan" value="{{old('pekerjaan', $data->pekerjaan)}}" id="pekerjaan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('pekerjaan')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="number" name="penghasilan" value="{{old('penghasilan', $data->penghasilan)}}" id="penghasilan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('penghasilan')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <select name="status_hubungan" id="status_hubungan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <option value="Anggota" {{old('status_hubungan', $data->status_hubungan) == "Anggota" ? "selected" : ""}}>Anggota</option>
                </select>
