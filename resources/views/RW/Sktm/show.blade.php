...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fillModal(rowData) {
            ...
            const dataLabels = ['No', 'Nama', 'Keterangan', 'Foto Rumah', 'Jumlah Penghasilan', 'Foto Slip Gaji', 'Jumlah Anggota Keluarga', 'Jumlah Kendaraan', 'Foto Kendaraan', 'Tanggal', 'Status', 'Catatan'];
