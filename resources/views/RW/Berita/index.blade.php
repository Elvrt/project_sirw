                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <form id="filter-form" method="GET" action="{{ url('/RW/Berita') }}">
                                        <div class="row">
                            ...
                            <tbody>
                                ...
                                @forelse ($berita as $data)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">
                                            <img src="{{$data->gambar_berita}}" width="200px" alt="gambar berita" class="border rounded">
                                        </td>
                                        ...
                                        <td class=" px-4 py-2">
                                            <div class="flex gap-3">
                                                <a href="/RW/Berita/{{ $data->id_berita }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">
...
@if(isset($data))
    @include('RW.Berita.show', ['data' => $data])
@endif
