...
<body class="bg-white">
    <div class="container pt-5 mx-auto">
        <h1 class="text-3xl font-bold mb-5">DATA KARTU KELUARGA</h1>
        @if(session('success'))
