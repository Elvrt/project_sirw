    ...
    <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-lg">
      ...
      <form>
        <div class="mb-6">
          ...
          <input type="email" id="email" name="email" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 " value="Ketikkan Username..." required>
        </div>
        <div class="mb-6">
        ...
        <button type="submit" class="w-32 bg-Button from-cyan-400 to-cyan-600 text-white py-2 rounded-lg mx-auto block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 mt-4 mb-6">Acceso</button>
      </form>
