...
<head>
    @extends('./layout/rt')
    <meta charset="UTF-8">
    <meta name="viewpoSktm" content="width=device-width, initial-scale=1.0">
            ...
            <div class="bg-putih drop-shadow-md mx-2 mt-5">
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <form id="filter-form" method="GET" action="{{ url('/RT/Sktm') }}">
                ...
                <div class="col-span-7 mt-4 p-10 sm:ml-68 text-left ml-10 pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table_persuratan" class="table-auto">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-4 py-2">Foto Rumah</th>
                            ...
                            <tbody>
                                @php
                                    $i = $startNumber;
                                @endphp
                                @forelse ($sktm as $data)
                                    <tr>
                                        <td class="px-4 py-2">{{$i++}}</td>
                                        <td class="px-4 py-2">{{$data->warga->nama_warga}}</td>
                                        <td class="px-4 py-2">{{$data->keterangan_sktm}}</td>
                                        <td class="px-4 py-2">
                                            <img src="{{ url('assets/img/rumah/' . $data->gambar_rumah) }}" width="200px" alt="foto rumah" class="border rounded">
                                        </td>
                                        <td class="px-4 py-2">{{$data->jumlah_penghasilan}}</td>
                                        <td class="px-4 py-2">
                                            <img src="{{ url('assets/img/slip/' . $data->gambar_slip) }}" width="200px" alt="foto slip gaji" class="border rounded">
                                        </td>
                                        ...
                                        <td class="px-4 py-2">
                                            <div class="flex gap-3">
                                                <a href="/RT/Sktm/{{ $data->id_sktm }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                                        <path d="M21.731 2.269a2.625 2.625 0 0 0-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 0 0 0-3.712ZM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 0 0-1.32 2.214l-.8 2.685a.75.75 0 0 0 .933.933l2.685-.8a5.25 5.25 0 0 0 2.214-1.32l8.4-8.4Z" />
                                                        <path d="M5.25 5.25a3 3 0 0 0-3 3v10.5a3 3 0 0 0 3 3h10.5a3 3 0 0 0 3-3V13.5a.75.75 0 0 0-1.5 0v5.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V8.25a1.5 1.5 0 0 1 1.5-1.5h5.25a.75.75 0 0 0 0-1.5H5.25Z" />
                                                    </svg>
                                                </a>
                                                <a href="#" data-toggle="modal" data-target="#ModalShow{{ $data->id_sktm }}" class="detail bg-abu-tua hover:bg-merah-gelap text-putih font-medium py-2 px-4 rounded-lg">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="13" class="text-center px-4 py-2">No data found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                        ...
                        <div class="mt-5  ">
                            {{ $sktm->appends(request()->query())->links() }}
                        </div>
                    </div>
                </div>
            </div>
...
@if(isset($data))
    @include('RT.Sktm.show', ['data' => $data])
@endif
