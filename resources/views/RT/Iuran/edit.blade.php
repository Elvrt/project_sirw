    ...
    <div class="bg-backgroundform md:mx-10 mr-3 md:mr-32 ml-4 md:ml-32 p-5 rounded-lg">
        ...
        <form action="{{url('/RT/Iuran/'.$data->id_iuran)}}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_iuran" value="{{old('tanggal_iuran', $data->tanggal_iuran)}}" id="tanggal_iuran" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('tanggal_iuran')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
