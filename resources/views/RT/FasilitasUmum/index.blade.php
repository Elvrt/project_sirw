                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">
                                            <div class="flex gap-3">
                                                <a href="/RT/FasilitasUmum/{{ $data->id_fasilitas }}/edit" class="bg-kuning hover:bg-kuning-gelap text-putih font-medium py-2 px-4 rounded-lg">
                                                ...
                                                <form action="{{ url('/RT/FasilitasUmum/' . $data->id_fasilitas) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
...
@if(isset($data))
    @include('RT.FasilitasUmum.show', ['data' => $data])
@endif
